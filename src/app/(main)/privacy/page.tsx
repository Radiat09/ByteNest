    ...
    <MainLayout>
      <div className="max-w-screen-2xl mx-auto lg:px-10 px-4 py-8">
        <div className="text-sm text-gray-400 mb-8">
          <span className="hover:text-brand cursor-pointer transition-colors">Home</span> / <span className="text-gray-800">Privacy Policy</span>
        </div>

        <div className="max-w-3xl">
          <span className="section-heading block mb-2">Legal</span>
          <h1 className="text-3xl font-bold mb-10 tracking-tight">Privacy Policy</h1>
          ...
          <div className="space-y-8 text-gray-600 leading-relaxed">
            ...
            <section>
              ...
              <p>You have the right to access, update, or delete your personal information. To exercise these rights, please contact us at <span className="text-brand">info@bytenest.com</span>.</p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-gray-800 mb-3">7. Data Retention</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-gray-800 mb-3">8. Changes to This Policy</h2>
            ...
            <section>
              ...
              <p>For questions about this Privacy Policy, contact us at <span className="text-brand">info@bytenest.com</span>.</p>
            </section>
          </div>
        </div>
      </div>
