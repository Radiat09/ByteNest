    ...
    <MainLayout>
      <div className="max-w-screen-2xl mx-auto lg:px-10 px-4 py-8">
        <div className="text-sm text-gray-400 mb-8">
          <span className="hover:text-brand cursor-pointer transition-colors">Home</span> / <span className="text-gray-800">Terms & Conditions</span>
        </div>

        <div className="max-w-3xl">
          <span className="section-heading block mb-2">Legal</span>
          <h1 className="text-3xl font-bold mb-10 tracking-tight">Terms & Conditions</h1>
          ...
          <div className="space-y-8 text-gray-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-bold text-gray-800 mb-3">2. Products & Pricing</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-gray-800 mb-3">3. Orders & Payment</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-gray-800 mb-3">4. Shipping & Delivery</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-gray-800 mb-3">5. Returns & Refunds</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-gray-800 mb-3">8. Changes to Terms</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-gray-800 mb-3">9. Contact Us</h2>
              <p>If you have any questions about these Terms & Conditions, please contact us at <span className="text-brand font-medium">info@bytenest.com</span>.</p>
            </section>
          </div>
        </div>
      </div>
