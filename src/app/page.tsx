...
export default function HomePage() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/products?limit=16`)
      .then((res) => res.json())
      .then(setProducts)
    ...
    fetch(`${API_URL}/products?limit=4&sortBy=sellCount&sortOrder=desc`)
      .then((res) => res.json())
      .then(setBestSelling)
      .catch(() => toast.error("Failed to load best sellers"));
  }, []);
        ...
        <section className="py-12">
          <div className="bg-black rounded-lg p-8 md:p-12 flex flex-col md:flex-row items-center justify-between">
            <div className="text-white mb-6 md:mb-0">
              ...
              <button className="bg-[rgb(219,68,68)] text-white px-6 py-2 rounded-lg font-medium hover:bg-[rgb(200,55,55)] transition-colors">
                Shop Now
              </button>
            </div>
            <img
