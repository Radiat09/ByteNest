      ...
      <div className="max-w-screen-2xl mx-auto lg:px-10 px-4">
        ...
        <section className="py-12">
          <div className="flex items-center gap-3 mb-6">
            <span className="w-5 h-10 rounded-sm bg-brand"></span>
            <span className="text-sm font-semibold text-brand">Today&apos;s</span>
          </div>
        ...
        <section className="py-12 border-t">
          <div className="flex items-center gap-3 mb-6">
            <span className="w-5 h-10 rounded-sm bg-brand"></span>
            <span className="text-sm font-semibold text-brand">Categories</span>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {categories.map((cat) => (
                <Link
                  ...
                  className="flex flex-col items-center p-6 border rounded-lg hover:shadow-md hover:border-brand transition-all"
                >
                  {cat.imageUrl ? (
                    <img src={cat.imageUrl} alt={cat.title} className="w-16 h-16 object-cover mb-3" />
                  ) : (
        ...
        <section className="py-12 border-t">
          <div className="flex items-center gap-3 mb-6">
            <span className="w-5 h-10 rounded-sm bg-brand"></span>
            <span className="text-sm font-semibold text-brand">This Month</span>
          </div>
        ...
        <section className="py-12 border-t">
          <div className="flex items-center gap-3 mb-6">
            <span className="w-5 h-10 rounded-sm bg-brand"></span>
            <span className="text-sm font-semibold text-brand">Our Products</span>
          </div>
